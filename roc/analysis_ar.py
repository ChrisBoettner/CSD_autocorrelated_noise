...
lm = np.load(source + "/lm_positive.npy");# lm[-1,:] = np.array([1,1,1,1,1])
#dw = np.load(source + "/dw_positive.npy"); dw[-1,:] = np.array([1,1,1,1,1])
#sp = np.load(source + "/sp_positive.npy"); sp[-1,:] = np.array([1,1,1,1,1])

lm_n = np.load(source + "/lm_positive_n.npy");# lm_n[-1,:] = np.array([1,1,1,1,1])
#dw_n = np.load(source + "/dw_positive_n.npy"); dw_n[-1,:] = np.array([1,1,1,1,1])
